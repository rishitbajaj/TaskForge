  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-forge-bg px-4">
      <div className="w-full max-w-md rounded-2xl border border-forge-border bg-forge-surface p-8">
        <h1 className="text-2xl font-bold text-white">Create your TaskForge account</h1>
        <p className="mt-2 text-sm text-forge-muted">Start organizing tasks in seconds</p>

        <ErrorBanner message={error} onDismiss={() => dispatch(clearAuthError())} />

        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          <div>
            <label htmlFor="name" className="mb-1 block text-xs font-semibold text-gray-400">
              NAME
            </label>
            <input
              id="name"
